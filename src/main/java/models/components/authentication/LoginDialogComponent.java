...
public class LoginDialogComponent {
    ...
    private final static By msgContent = MobileBy.id("android:id/message");
    ...
    public String msgContent(){
        WebDriverWait wait = new WebDriverWait(appiumDriver, 15);
        wait.until(ExpectedConditions.presenceOfElementLocated(msgContent));
        return appiumDriver.findElement(msgContent).getText();
    }
}
